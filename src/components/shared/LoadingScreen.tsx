...
export default function LoadingScreen() {
 ...
 <motion.h2 className="relative text-4xl md:text-5xl font-heading font-bold mb-6 text-center text-primary-saffron " initial={{ y: 30, opacity: 0, scale: 0.95 }} animate={{ y: 0, opacity: 1, scale: 1, transition: { duration: 0.9, ease: 'easeOut' } }}>
 Beloved India
 </motion.h2>
