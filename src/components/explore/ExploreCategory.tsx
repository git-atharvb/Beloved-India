      ...
      <button
        ...
        className={clsx(
          ...
          selectedCategory === ''
            ...
            : 'bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-200 hover:bg-primary-100 dark:hover:bg-primary-900 hover:text-primary-700 dark:hover:text-primary-100',
        )}
      >
        All Categories
      </button>
